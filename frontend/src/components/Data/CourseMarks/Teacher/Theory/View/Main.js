...
import TheoryMarksTable from './TheoryMarksTable.js'

const emptyArray = []

function TeacherCourseMarksTheoryView({
  TeacherId,
  TermId,
  CourseId,
  enrollments,
  ...
  return (
    <>
      <Segment>
        <HeaderGrid
          Left={<Header>Theory Marks [Section {section}]</Header>}
          Right={
            <Dropdown
              search
              selection
