...
import TeacherCourseMarksSessionalEditForm from './Form.js'

const emptyArray = []

function TeacherCourseMarksSessionalEdit({
  TeacherId,
  TermId,
  CourseId,
  enrollments,
...
const mapStateToProps = (
  { courses, enrollments, termcourses },
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(TeacherCourseMarksSessionalEdit)
